...
class AdminCountryController extends AbstractController
{
    ...
    public function new(Request $request, CountryRepository $countryRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_country_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('admin_country/new.html.twig', [
            'country' => $country,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin_country/show.html.twig', [
            'country' => $country,
        ]);
    }
    ...
    public function edit(Request $request, Country $country, CountryRepository $countryRepository): Response
    {
        ...
        return $this->renderForm('admin_country/edit.html.twig', [
            'country' => $country,
            'form' => $form,
        ]);
    }
