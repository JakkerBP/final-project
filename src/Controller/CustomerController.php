...
class CustomerController extends AbstractController
{
    ...
    #[Route('customer/', name: 'app_register_details', methods: ['GET', 'POST'])]
    ...
    #[Route('customer/edit', name: 'app_register_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request,UserRepository $userRepository, CustomerRepository $customerRepository): Response
    {   
        $user = $this->getUser();
        $form = $this->createForm(RegistrationFormType::class, $user);
        $form->handleRequest($request);
        $customerAdress = $this->getUser()->getCustomer()->getAdress();
        // dd($customerAdress);
